var rightListCtrl = function ($scope, RightService) {
    ...
    $scope.data.gotoPage = function (pageSize, pageNumber) {
        ...
        RightService.getAll(pageSize, pageNumber, $scope.data.filter.rightName).then(function (data) {
            ...
            $scope.data.rightList = data.List;
